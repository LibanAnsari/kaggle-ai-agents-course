...
#     [
#         "uvicorn",
#         "product_catalog_server:product_catalog_a2a_app",  # Module:app format
#         "--host",
#         "localhost",
#         "--port",
#         "8001",
#     ],
#     cwd="C:/Users/liban/OneDrive/Desktop/Study/5-Days-AI-Agents-Kaggle/Day5/agent2agent-communication",  # Run from /tmp where the file is
...
# ABOVE CODES ARE FOR JUPYTER NOTEBOOK ON KAGGLE

if __name__ == "__main__":
    import uvicorn
    uvicorn.run(
        "product_catalog_server:product_catalog_a2a_app",
        host="localhost",
        port=8001,
        reload=False
    )
